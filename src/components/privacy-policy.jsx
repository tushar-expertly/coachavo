    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Coachavo, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Coachavo.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            At Coachavo, we will only request personal information when it is
          ...
          <p className="mb-4">
            If Coachavo invites you to complete and submit an online form, your
          ...
          <p className="mb-4">
            It's important to note that while Coachavo may track a visitor's
          ...
          <p className="mb-4">
            Coachavo may utilize your personal information to:
          </p>
          <ul>
            <li>
          ...
          <p className="mb-4">
            If you wish to be removed from any Coachavo distribution list,
            simply click on the provided link within each electronic
            communication or reply to the email with the subject line
            "unsubscribe".
          </p>
          <p className="mb-4">
            If you have provided your telephone number to Coachavo, you may
          ...
          <p className="mb-4">
            The Coachavo website may contain links to external websites,
            ...
            are not governed by Coachavo's privacy policy. Coachavo has no
          ...
          <p className="mb-4">
            ...
            Coachavo's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Coachavo
          ...
          <p className="mb-4">
            ...
            paramount at Coachavo. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Coachavo, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Coachavo remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Coachavo, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Coachavo is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Coachavo is
          ...
          <p className="mb-4">
            Coachavo is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Coachavo reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Coachavo’s website to stay informed of any updates.
